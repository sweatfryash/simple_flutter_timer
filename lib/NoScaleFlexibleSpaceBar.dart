...
class NoScaleFlexibleSpaceBar extends StatefulWidget {
  /// Creates a flexible space bar.
  ///
  /// Most commonly used in the [AppBar.flexibleSpace] field.
  const NoScaleFlexibleSpaceBar({
    Key key,
    this.title,
    this.background,
    this.centerTitle,
  ...
  /// to the [NoScaleFlexibleSpaceBar].
  ///
  ...
  /// [NoScaleFlexibleSpaceBar] when fully collapsed. `maxExtent` sets the maximum
  /// height of the resulting [NoScaleFlexibleSpaceBar] when fully expanded.
  /// `currentExtent` sets the scale of the [NoScaleFlexibleSpaceBar.background] and
  /// [NoScaleFlexibleSpaceBar.title] widgets of [NoScaleFlexibleSpaceBar] upon
  /// initialization.
  ///
  /// See also:
  ///
  ...
  @override
  _NoScaleFlexibleSpaceBarState createState() => _NoScaleFlexibleSpaceBarState();
}

class _NoScaleFlexibleSpaceBarState extends State<NoScaleFlexibleSpaceBar> {
